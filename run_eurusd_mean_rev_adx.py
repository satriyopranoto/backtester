"""
Backtest Mean Reversion ADX — EUR/USD Daily, last 2 years.

Entry: Low>SL & ADX<25 & ADX declining & PDI>MDI & PDI rising & MDI declining
Exit : Low<entry_sl (CL)  or  floating>0.4R + ADX<25 + ADX declining + PDI<PDI[5] + MDI>PDI
"""
...
print("=" * 60)
print("  Mean Reversion ADX — EUR/USD Daily (2 tahun)")
print("=" * 60)
